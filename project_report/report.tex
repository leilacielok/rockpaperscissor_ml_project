...
training protocol fixed. Formally, each model defines a mapping 
...
parameter count and spatial flexibility, but reduces the implicit spatial 
regularization induced by global pooling. 
...
feature extraction under constrained data regimes. It starts with a 
