...
At the classification stage, all models adopt global average pooling in place of flattening, enforcing translation invariance and reducing the risk of overfitting by preventing the classifier from relying on specific spatial positions. In addition, a modest dropout rate is applied to the final dense layer across architectures to further discourage co-adaptation of high-level features.
...
In addition to accuracy-based metrics, the distribution of predicted probabilities provides a coarse \emph{proxy} of confidence calibration.
...
Accordingly, for completeness, a summary of model capacity and confidence-related diagnostics is reported in Table~\ref{tab:model_capacity}.
