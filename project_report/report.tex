...
matched tuning conditions. The final model was selected as the overall 
best-performing configuration across the entire grid: Model C trained 
with learning rate $3\times 10^{-4}$, batch size 16, and augmentation 
disabled achieved the highest validation accuracy observed during 
