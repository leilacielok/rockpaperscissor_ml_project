...
shown in Figures~\ref{fig:app_misclf_A}, ~\ref{fig:app_misclf_B} and
~\ref{fig:app_misclf_C} (models A–C), ordered by decreasing prediction 
confidence.
...
and show limited structural coherence, consistently with the uneven class-wise 
recall reported in Section 3.1. In practical terms, the “missed detections” 
