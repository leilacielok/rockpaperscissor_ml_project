...
This project investigated the effectiveness of convolutional neural networks 
with increasing architectural complexity for classifying hand-gesture 
images representing rock, paper, and scissors. Through a systematic 
comparison of three CNN architectures trained under identical
...
environments.
From an application perspective, the final model could be deployed as a
lightweight web application enabling interactive rock--paper--scissors play
