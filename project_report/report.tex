...
sesitivity under distributional shifts, as later evidenced in the 
...
(48$\times$48, 24$\times$24, 12$\times$12), enabling the learning of hierarchical 
representations ranging from local edge-like features to more abstract, gesture-level 
...
For completeness, Table~\ref{tab:model_capacity} summarizes the resulting
differences in model capacity across architectures. Notably, while Model B
exhibits a substantially larger number of trainable parameters due to its
fully connected classifier, Model C achieves greater architectural
expressiveness with a markedly smaller parameter footprint, highlighting
the role of architectural design in achieving parameter-efficient
