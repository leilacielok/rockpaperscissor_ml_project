...
\title{Convolutional Neural Network Architectures for Rock--Paper--Scissors Image Classification}
\author{Leila Cielok}
\date{\today}
...
For completeness, a summary of model capacity and confidence-related diagnostics is reported in
Appendix~A (Table~\ref{tab:model_capacity}).
...
A clear and monotonic improvement emerges across architectures. The
...
\textbf{Sec. 2.1: {[}Appendix material (per Model A, B, C):} validation
classification reports, validation confusion matrices, training loss
curves, and training accuracy curves.{]}
